...
static UINT  _lx_nand_flash_read_driver(ULONG block, ULONG page, ULONG *destination, ULONG words)
{
  ...
  if (BSP_FMC_NAND_Read(NAND_INSTANCE, &Bsp_Address, (uint8_t *) destination, 1)!= HAL_OK)
  {
    return(LX_ERROR);
  }
...
static UINT  _lx_nand_flash_write_driver(ULONG block, ULONG page, ULONG *source, ULONG words)
{
  ...
  if (BSP_FMC_NAND_Write(NAND_INSTANCE, &Bsp_Address, (uint8_t *) source, 1) != HAL_OK)
  {
    return(LX_ERROR);
  }
...
static UINT  _lx_nand_flash_block_erase_driver(ULONG block, ULONG erase_count)
{
  ...
  if (BSP_FMC_NAND_Erase_Block(NAND_INSTANCE, &BspAddress) != HAL_OK)
  {
    return(LX_ERROR);
  }
...
{
  if (BSP_FMC_NAND_EraseChip(NAND_INSTANCE) != HAL_OK)
  {
    return(LX_ERROR);
  }
...
static UINT  _lx_nand_flash_page_erased_verify_driver(ULONG block, ULONG page)
{
  ...
  if (BSP_FMC_NAND_Read(NAND_INSTANCE, &Bsp_Address, (uint8_t *) nand_flash_rw_buffer, 1)!= HAL_OK)
  {
    return(LX_ERROR);
  }
...
static UINT  _lx_nand_flash_block_status_get_driver(ULONG block, UCHAR *bad_block_byte)
{
  ...
  if (BSP_FMC_NAND_Read_SpareArea(NAND_INSTANCE, &Bsp_Address, (uint8_t *) Buffer_Spare_Area, 1) != HAL_OK)
  {
    return(LX_ERROR);
  }
...
static UINT  _lx_nand_flash_block_status_set_driver(ULONG block, UCHAR bad_block_byte)
{
  ...
  if (BSP_FMC_NAND_Write_SpareArea(NAND_INSTANCE, &Bsp_Address, (uint8_t *) Buffer_Spare_Area, 1) != HAL_OK)
  {
    return(LX_ERROR);
  }
