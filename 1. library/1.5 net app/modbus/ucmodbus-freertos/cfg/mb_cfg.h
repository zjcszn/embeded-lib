...
#define  MODBUS_CFG_USE_DMATX              DEF_ENABLED

#define  MODBUS_CFG_RS485_EN               DEF_DISABLED

#define  MODBUS_CFG_PRINT_EN               DEF_DISABLED          /* Enable or Disable Mobus Debug Log                  */

#if     (MODBUS_CFG_PRINT_EN == DEF_ENABLED)
#include <stdio.h>
#define  MB_LOG(...)                       printf(__VA_ARGS__)
#define  MB_LOG_CONDI(exp, ...)            do                                 \
                                           {                                  \
                                            if ((exp)) MB_LOG(__VA_ARGS__);   \
                                           } while (0U)
#else
#define  MB_LOG(...)                       ((void)0U)
#define  MB_LOG_CONDI(exp, ...)            ((void)0U)                
#endif
