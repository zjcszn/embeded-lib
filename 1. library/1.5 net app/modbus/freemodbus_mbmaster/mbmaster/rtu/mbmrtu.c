            ...
            ( usMBPDULength <= ( MBM_SER_PDU_SIZE_MAX - ( 1 /* Slave Address */ + 2 /* CRC16 */ ) ) ) )
        {
            ...
            if( MB_ENOERR !=
                ( eStatus = eMBPSerialTxEnable(
                      pxRTUHdl->xSerHdl, ( pbMBPSerialTransmitterEmptyCB )bMBMSerialRTUTransmitterEmptyAPIV2CB ) ) )
            {
            ...
            if( MB_ENOERR !=
                ( eStatus = eMBPSerialTxEnable(
                      pxRTUHdl->xSerHdl, ( pbMBPSerialTransmitterEmptyCB )bMBMSerialRTUTransmitterEmptyAPIV1CB ) ) )
            {
                HDL_RESET_TX( pxRTUHdl );
            }
#else
