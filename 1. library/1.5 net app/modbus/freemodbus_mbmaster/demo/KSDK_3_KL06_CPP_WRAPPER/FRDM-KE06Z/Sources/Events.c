...
{
  /* Write your code here ... */
	BaseType_t doContextSwitch = prvMBPSerialReceiveBlock( ( UBYTE )UserDataPtr );
	portYIELD_FROM_ISR( doContextSwitch );
}
...
{
	/* Write your code here ... */
	BaseType_t doContextSwitch = prvMBPSerialCanTransmit( ( UBYTE )UserDataPtr );
	portYIELD_FROM_ISR( doContextSwitch );
}
...
{
  /* Write your code here ... */
	BaseType_t doContextSwitch = prvMBPSerialTimeoutDetect( );
	doContextSwitch |= prvMBPTimerTickMS( );
	portYIELD_FROM_ISR( doContextSwitch );
}
