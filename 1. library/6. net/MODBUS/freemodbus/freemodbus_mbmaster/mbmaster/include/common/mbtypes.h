...
#define MB_ERROR_IS_EXCEPTION( eStatus ) \
    ( ( ( eStatus ) >= MB_EX_ILLEGAL_FUNCTION ) && ( ( eStatus ) <= MB_EX_GATEWAY_TARGET_FAILED ) ? TRUE : FALSE )
 ...
 */
typedef void ( *pvMBAnalyzerCallbackCB )( xMBHandle xHdl, void *pxCtx, const xMBPTimeStamp *pxTime,
