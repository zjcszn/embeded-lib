            ...
            ( usMBPDULength <= ( MBM_SER_PDU_SIZE_MAX - ( 1 /* Slave Address */ + 1 /* LRC */ ) ) ) )
        {
            ...
            if( MB_ENOERR !=
                ( eStatus = eMBPSerialTxEnable(
                      pxASCIIHdl->xSerHdl, ( pbMBPSerialTransmitterEmptyCB )bMBMSerialASCIITransmitterEmptyAPIV1CB ) ) )
            {
            ...
            if( MB_ENOERR !=
                ( eStatus = eMBPSerialTxEnable(
                      pxASCIIHdl->xSerHdl, ( pbMBPSerialTransmitterEmptyCB )bMBMSerialASCIITransmitterEmptyAPIV2CB ) ) )
            {
                HDL_RESET_TX( pxASCIIHdl );
            }
#else
