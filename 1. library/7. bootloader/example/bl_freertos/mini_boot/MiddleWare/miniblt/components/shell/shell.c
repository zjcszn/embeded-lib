 ...
 * 
 */
_Noreturn void shellTask(void *param)
{
    char data;
    Shell *shell = (Shell *)param;

    static lwwdg_wdg_t wdg_shell;
    lwwdg_add(&wdg_shell, BSP_WDG_TASK_TIMEOUT);
