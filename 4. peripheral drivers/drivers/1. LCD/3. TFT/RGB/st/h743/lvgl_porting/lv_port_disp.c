...
//                          MY_DISP_HOR_RES * 10);   /*Initialize the display buffer*/
    ...
    extern uint32_t ltdc_framebuf_1[LCD_WIDTH * LCD_HEIGHT];
    extern uint32_t ltdc_framebuf_2[LCD_WIDTH * LCD_HEIGHT];
    
    lv_disp_draw_buf_init(&draw_buf_dsc_3, ltdc_framebuf_1, ltdc_framebuf_2,
