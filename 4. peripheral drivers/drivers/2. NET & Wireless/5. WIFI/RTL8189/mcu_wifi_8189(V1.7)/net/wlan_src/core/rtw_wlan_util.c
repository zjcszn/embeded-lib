...
const unsigned char EPIGRAM_OUI[] = {0x00, 0x90, 0x4c};
...
const static u8 rtw_basic_rate_cck[4] = {
	IEEE80211_CCK_RATE_1MB|IEEE80211_BASIC_RATE_MASK, IEEE80211_CCK_RATE_2MB|IEEE80211_BASIC_RATE_MASK,
	IEEE80211_CCK_RATE_5MB|IEEE80211_BASIC_RATE_MASK, IEEE80211_CCK_RATE_11MB|IEEE80211_BASIC_RATE_MASK
};

const static u8 rtw_basic_rate_ofdm[3] = {
	IEEE80211_OFDM_RATE_6MB|IEEE80211_BASIC_RATE_MASK, IEEE80211_OFDM_RATE_12MB|IEEE80211_BASIC_RATE_MASK,
	IEEE80211_OFDM_RATE_24MB|IEEE80211_BASIC_RATE_MASK
};

const static u8 rtw_basic_rate_mix[7] = {
	IEEE80211_CCK_RATE_1MB|IEEE80211_BASIC_RATE_MASK, IEEE80211_CCK_RATE_2MB|IEEE80211_BASIC_RATE_MASK,
	IEEE80211_CCK_RATE_5MB|IEEE80211_BASIC_RATE_MASK, IEEE80211_CCK_RATE_11MB|IEEE80211_BASIC_RATE_MASK,
	IEEE80211_OFDM_RATE_6MB|IEEE80211_BASIC_RATE_MASK, IEEE80211_OFDM_RATE_12MB|IEEE80211_BASIC_RATE_MASK,
	IEEE80211_OFDM_RATE_24MB|IEEE80211_BASIC_RATE_MASK
...
int rtw_check_bcn_info(ADAPTER *Adapter, u8 *pframe, u32 packet_len)
{
	...
	cur_network_type=cur_network_type;
...
unsigned int is_ap_in_tkip(_adapter *padapter)
{
	...
	if (rtw_get_capability((WLAN_BSSID_EX *)cur_network) & WLAN_CAPABILITY_PRIVACY)
	{
		for (i = sizeof(NDIS_802_11_FIXED_IEs); i < pmlmeinfo->network.IELength;)
		{
			...
			{
				case _VENDOR_SPECIFIC_IE_:
					if ((_rtw_memcmp(pIE->data, (void*)RTW_WPA_OUI, 4)) && (_rtw_memcmp((pIE->data + 12), (void*)WPA_TKIP_CIPHER, 4))) 
					{
						return _TRUE;
					}
					break;
				...
				case _RSN_IE_2_:
					if (_rtw_memcmp((pIE->data + 8), (void*)RSN_TKIP_CIPHER, 4)) 
					{
						return _TRUE;
					}
			...
			switch (pIE->ElementID)
			{
				case _VENDOR_SPECIFIC_IE_:
					if (_rtw_memcmp(pIE->data, (void*)RTW_WPA_OUI, 4) &&
						((_rtw_memcmp((pIE->data + 12), (void*)_WPA_CIPHER_SUITE_CCMP, 4)) ||
						  (_rtw_memcmp((pIE->data + 16), (void*)_WPA_CIPHER_SUITE_CCMP, 4))))
						return _FALSE;
					break;

				case _RSN_IE_2_:
					if  ((_rtw_memcmp((pIE->data + 8), (void*)_RSN_CIPHER_SUITE_CCMP, 4))  ||
					       (_rtw_memcmp((pIE->data + 12), (void*)_RSN_CIPHER_SUITE_CCMP, 4)))
					return _FALSE;
...
void update_tx_basic_rate(_adapter *padapter, u8 wirelessmode)
{
	...
	if ((wirelessmode & WIRELESS_11B) && (wirelessmode == WIRELESS_11B)) {
		_rtw_memcpy(supported_rates, (void*)rtw_basic_rate_cck, 4);
	} else if (wirelessmode & WIRELESS_11B) {
		_rtw_memcpy(supported_rates, (void*)rtw_basic_rate_mix, 7);
	} else {
		_rtw_memcpy(supported_rates, (void*)rtw_basic_rate_ofdm, 3);
	}
...
unsigned char check_assoc_AP(u8 *pframe, uint len)
{
	...
	for (i = sizeof(NDIS_802_11_FIXED_IEs); i < len;)
	{
		...
		{
			case _VENDOR_SPECIFIC_IE_:
				if ((_rtw_memcmp(pIE->data, (void*)ARTHEROS_OUI1, 3)) || (_rtw_memcmp(pIE->data, (void*)ARTHEROS_OUI2, 3)))
				{
					DBG_871X("link to Artheros AP\n");
					return HT_IOT_PEER_ATHEROS;
				}
				else if ((_rtw_memcmp(pIE->data, (void*)BROADCOM_OUI1, 3))
							|| (_rtw_memcmp(pIE->data, (void*)BROADCOM_OUI2, 3))
							|| (_rtw_memcmp(pIE->data, (void*)BROADCOM_OUI2, 3)))
				{
					DBG_871X("link to Broadcom AP\n");
					return HT_IOT_PEER_BROADCOM;
				}
				else if (_rtw_memcmp(pIE->data, (void*)MARVELL_OUI, 3))
				{
					DBG_871X("link to Marvell AP\n");
					return HT_IOT_PEER_MARVELL;
				}
				else if (_rtw_memcmp(pIE->data, (void*)RALINK_OUI, 3))
				{
				...
				else if (_rtw_memcmp(pIE->data, (void*)CISCO_OUI, 3))
				{
					DBG_871X("link to Cisco AP\n");
					return HT_IOT_PEER_CISCO;
				}
				else if (_rtw_memcmp(pIE->data, (void*)REALTEK_OUI, 3))
				{
					DBG_871X("link to Realtek 96B\n");
					return HT_IOT_PEER_REALTEK;
				}
				else if (_rtw_memcmp(pIE->data, (void*)AIRGOCAP_OUI,3))
				{
					DBG_871X("link to Airgo Cap\n");
					return HT_IOT_PEER_AIRGO;
				}
				else if (_rtw_memcmp(pIE->data, (void*)EPIGRAM_OUI, 3))
				{
...
void update_bmc_sta_support_rate(_adapter *padapter, u32 mac_id)
{
	...
	if(pmlmeext->cur_wireless_mode & WIRELESS_11B)
	{
		...
		_rtw_memcpy((pmlmeinfo->FW_sta_info[mac_id].SupportedRates), (void*)rtw_basic_rate_cck, 4);
	}
	else
	{
		_rtw_memcpy((pmlmeinfo->FW_sta_info[mac_id].SupportedRates), (void*)rtw_basic_rate_ofdm, 4);
	}
}
