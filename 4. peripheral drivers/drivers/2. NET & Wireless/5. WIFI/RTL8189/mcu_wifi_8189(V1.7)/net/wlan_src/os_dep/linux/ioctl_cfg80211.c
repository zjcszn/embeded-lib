...
const static struct ieee80211_rate rtw_rates[] = {
...
#define CHAN2G(_channel, _freq, _flags) {IEEE80211_BAND_2GHZ,(_freq),(_channel),(_flags),0,30,(bool)0,0,0,0}

const static struct ieee80211_channel rtw_2ghz_channels[] = {
	CHAN2G(1, 2412, 0),
	CHAN2G(2, 2417, 0),
	CHAN2G(3, 2422, 0),
	CHAN2G(4, 2427, 0),
...
#define CHAN5G(_channel, _flags) {IEEE80211_BAND_5GHZ,(5000 + (5 * (_channel))),(_channel),(_flags),0,30,(bool)0,0,0,0}

const static struct ieee80211_channel rtw_5ghz_a_channels[] = {
...
{
	_rtw_memcpy(rates, (void*)rtw_g_rates,
...
{
	_rtw_memcpy(rates, (void*)rtw_a_rates,
...
extern void handle_user_scan_result(struct wlan_network *pnetwork);
...
*/
	...
	fctrl = (unsigned short *)&(pwlanhdr->frame_ctl);
	*(fctrl) = 0;	
	...
	//}
	//#endif
	handle_user_scan_result(pnetwork);
...
_func_enter_;
	...
	if (strcmp((char*)param->u.crypt.alg, "WEP") == 0)
	{
	...
	if(padapter->securitypriv.dot11AuthAlgrthm == dot11AuthAlgrthm_8021X) // 802_1x
	{
		...
		if (check_fwstate(pmlmepriv, WIFI_STATION_STATE | WIFI_MP_STATE) == _TRUE) //sta mode
		{
			...
			else
			{
				...
				if (strcmp((char*)param->u.crypt.alg, "none") != 0) 
					psta->ieee8021x_blocked = _FALSE;
				...
				{ 
					...
					if(strcmp((char*)param->u.crypt.alg, "TKIP") == 0)//set mic key
					{						
...
*/
extern void cfg80211_scan_done(struct rtw_wdev_priv *pwdev_priv, bool aborted);
...
void rtw_cfg80211_indicate_scan_done(struct rtw_wdev_priv *pwdev_priv, bool aborted)
{
	...
	if(pwdev_priv->scan_request != NULL)
	{
		...
		{
			cfg80211_scan_done(pwdev_priv, aborted);
		}
...
wait_for_surveydone=wait_for_surveydone;
	...
	while(1)
	{
		...
		{		
			...
			rtw_get_bcn_info(pnetwork); //add by lck
...
p2p_ielen=p2p_ielen;
	...
	if(len>0)
	{
		if((wps_ie = rtw_get_wps_ie((u8*)buf, len, NULL, &wps_ielen))!=0)
		{
			#ifdef CONFIG_DEBUG_CFG80211
...
if (padapter->registrypriv.mp_mode == 1)
{
	...
	{
		rtw_cfg80211_set_probe_req_wpsp2pie(padapter, (char *)request->ie, request->ie_len );
	}
...
int rtw_cfg80211_set_wpa_version(struct security_priv *psecuritypriv, u32 wpa_version)
{	
...
int rtw_cfg80211_set_auth_type(struct security_priv *psecuritypriv,
...
int rtw_cfg80211_set_cipher(struct security_priv *psecuritypriv, u32 cipher, bool ucast)
{
...
int rtw_cfg80211_set_key_mgt(struct security_priv *psecuritypriv, u32 key_mgt)
{
...
int rtw_cfg80211_set_wpa_ie(_adapter *padapter, u8 *pie, size_t ielen)
{
...
pos=pos;
	...
	pwpa = rtw_get_wpa_ie(buf, (u32*)&wpa_ielen, ielen);
	if(pwpa && wpa_ielen>0)
	{
	...
	pwpa2 = rtw_get_wpa2_ie(buf, (u32*)&wpa2_ielen, ielen);
...
#ifdef WPS_IE_ALLOC_DYNAMIC
            if(padapter->securitypriv.wps_ie_len < wps_ielen)
            {
                if(padapter->securitypriv.wps_ie)
                    mem_free(padapter->securitypriv.wps_ie);

                padapter->securitypriv.wps_ie = (u8*)mem_calloc(wps_ielen + 32, 1);
                if(!padapter->securitypriv.wps_ie)
                    padapter->securitypriv.max_wps_ie_len = 0;
                else
                    padapter->securitypriv.max_wps_ie_len = wps_ielen + 32;
            }
#endif
...
static int rtw_cfg80211_add_monitor_if(_adapter *padapter, char *name, struct net_device **ndev)
{
	...
	mon_ndev = (struct net_device *)mem_calloc(sizeof(struct rtw_netdev_priv_indicator) + sizeof(struct net_device), 1);
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(3,6,0))
    p_err_fun;
	return ndev ? ndev->ieee80211_ptr : /*ERR_PTR(ret)*/0;
#elif (LINUX_VERSION_CODE >= KERNEL_VERSION(2,6,38)) || defined(COMPAT_KERNEL_RELEASE)
...
//	u8 got_p2p_ie = _FALSE;
	...
	rtw_ies_remove_ie(pbuf, &len, _BEACON_IE_OFFSET_, _VENDOR_SPECIFIC_IE_, (u8*)P2P_OUI, 4);
	rtw_ies_remove_ie(pbuf, &len, _BEACON_IE_OFFSET_, _VENDOR_SPECIFIC_IE_, (u8*)WFD_OUI, 4);
...
//	u8 *wfd_ie;
	...
	if(len>0)
	{
		...
		{	
			...
			{
				#ifdef CONFIG_DEBUG_CFG80211		
				//DBG_871X("config_method in wpsie of probe_resp = 0x%x\n", be16_to_cpu(*puconfig_method));
				#endif
...
//	u32	p2p_ielen = 0;
	...
	if(	(rtw_get_wps_ie((u8*)buf, len, NULL, &wps_ielen) && (wps_ielen>0))
		#ifdef CONFIG_P2P
...
const struct cfg80211_ops rtw_cfg80211_ops = {
    ...
    /*.get_key = 0,*/cfg80211_rtw_get_key,
   ...
   /* .connect = */cfg80211_rtw_connect,
    ...
    /*.get_tx_power = 0,*/cfg80211_rtw_get_txpower,
    /*.set_wds_peer = 0,*/
    /*.rfkill_poll = 0,*/
   /* .set_bitrate_mask = 0,*/

	/*.mgmt_tx = *//*cfg80211_rtw_mgmt_tx*/0,
    ...
    /*.mgmt_frame_register = *//*cfg80211_rtw_mgmt_frame_register*/0,
    /*.set_channel = */0,
...
static void rtw_cfg80211_preinit_wiphy(_adapter *padapter, struct wiphy *wiphy)
{
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(2,6,37)) || defined(COMPAT_KERNEL_RELEASE)	
#ifdef CONFIG_AP_MODE
	wiphy->mgmt_stypes = (struct ieee80211_txrx_stypes *)rtw_cfg80211_default_mgmt_stypes;
#endif //CONFIG_AP_MODE	
#endif		
	...
	*/
	...
	wiphy->n_cipher_suites = /*ARRAY_SIZE(rtw_cipher_suites)*/4;
...
int rtw_wdev_alloc(_adapter *padapter/*, struct device *dev*/)
{
    ...
    wiphy = mem_calloc(sizeof(struct wiphy) + sizeof(struct rtw_wdev_priv), 1);
	wiphy->priv = wiphy + 1;
    pnetdev->cfg80211_ops = &rtw_cfg80211_ops;
	if (!wiphy) {
