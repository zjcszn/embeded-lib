...
#define _WPA_SELECTOR_LEN 4
extern const u8 _RTW_WPA_OUI_TYPE[] ;
extern const u16 _RTW_WPA_VERSION ;
extern const u8 _WPA_AUTH_KEY_MGMT_NONE[];
extern const u8 _WPA_AUTH_KEY_MGMT_UNSPEC_802_1X[];
extern const u8 _WPA_AUTH_KEY_MGMT_PSK_OVER_802_1X[];
extern const u8 _WPA_CIPHER_SUITE_NONE[];
extern const u8 _WPA_CIPHER_SUITE_WEP40[];
extern const u8 _WPA_CIPHER_SUITE_TKIP[];
extern const u8 _WPA_CIPHER_SUITE_WRAP[];
extern const u8 _WPA_CIPHER_SUITE_CCMP[];
extern const u8 _WPA_CIPHER_SUITE_WEP104[];


#define RSN_HEADER_LEN 4
#define RSN_SELECTOR_LEN 4

extern const u16 _RSN_VERSION_BSD;
extern const u8 _RSN_AUTH_KEY_MGMT_UNSPEC_802_1X[];
extern const u8 _RSN_AUTH_KEY_MGMT_PSK_OVER_802_1X[];
extern const u8 _RSN_CIPHER_SUITE_NONE[];
extern const u8 _RSN_CIPHER_SUITE_WEP40[];
extern const u8 _RSN_CIPHER_SUITE_TKIP[];
extern const u8 _RSN_CIPHER_SUITE_WRAP[];
extern const u8 _RSN_CIPHER_SUITE_CCMP[];
extern const u8 _RSN_CIPHER_SUITE_WEP104[];
...
struct ieee80211_txb {
	...
	u16 frag_size;
	u16 payload_size;
	struct sk_buff *fragments[ZEROSIZE];
};
...
enum secondary_ch_offset {
	...
	_SCB = 3,  /* secondary channel below */
};
