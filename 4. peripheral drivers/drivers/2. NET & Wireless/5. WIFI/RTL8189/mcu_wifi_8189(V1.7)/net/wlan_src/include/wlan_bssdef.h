...
typedef struct __packed _NDIS_802_11_SSID
{
  ULONG  SsidLength;
  UCHAR  Ssid[32];
...
typedef struct __packed _NDIS_802_11_CONFIGURATION_FH
{
...
*/
typedef struct __packed _NDIS_802_11_CONFIGURATION
{
    ULONG           Length;             // Length of structure
...
typedef struct __packed _WLAN_PHY_INFO
{
