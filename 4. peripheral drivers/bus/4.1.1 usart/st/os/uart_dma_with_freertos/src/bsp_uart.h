...
#define DMA_CLEAR_IT_FLAG_(stream, flag, dma)   LL_DMA_ClearFlag_ ## flag ## stream(dma)
#define DMA_CLEAR_IT_FLAG(stream, flag, dma)    DMA_CLEAR_IT_FLAG_(stream, flag, dma)
