...
typedef struct {
    ...
    uint32_t freq_khz;    ///< I2C Frequency in kHz
    uint32_t sys_clk_hz;  ///< System Clock in Hz (pass 0 to auto-detect)
} sw_i2c_port_cfg_t;
 ...
 * @param  cfg        Configuration structure with port/pin/freq details
 * @return sw_i2c_err_t
 */
