...
const static u4Byte edca_setting_UL[HT_IOT_PEER_MAX] = 
...
const static u4Byte edca_setting_DL[HT_IOT_PEER_MAX] = 
...
const static u4Byte edca_setting_DL_GMode[HT_IOT_PEER_MAX] = 
...
const u4Byte EDCAParam[HT_IOT_PEER_MAX][3] =
{          // UL			DL
...
// Global var
//============================================================
const u4Byte OFDMSwingTable[OFDM_TABLE_SIZE_92D] = {
	0x7f8001fe, // 0, +6.0dB
	0x788001e2, // 1, +5.5dB
	0x71c001c7, // 2, +5.0dB
	0x6b8001ae, // 3, +4.5dB
...
const u1Byte CCKSwingTable_Ch1_Ch13[CCK_TABLE_SIZE][8] = {
...
const u1Byte CCKSwingTable_Ch14 [CCK_TABLE_SIZE][8]= {
...
const unsigned int TxPwrTrk_OFDM_SwingTbl[TxPwrTrk_OFDM_SwingTbl_Len] = {
	/*  +6.0dB */ 0x7f8001fe,
	/*  +5.5dB */ 0x788001e2,
	/*  +5.0dB */ 0x71c001c7,
	/*  +4.5dB */ 0x6b8001ae,
	...
	)
{
	...
	//DBG_871X("==>%s,RATRState:0x%02x ,RSSI:%d \n",__FUNCTION__,RATRState,RSSI);
	...
	)
{
	...
	//if(check_fwstate(&Adapter->mlmepriv, WIFI_AP_STATE|WIFI_ADHOC_STATE|WIFI_ADHOC_MASTER_STATE) == _TRUE)
	{
		...
		for(i=0; i<ODM_ASSOCIATE_ENTRY_NUM; i++) {
			if ((IS_STA_VALID(psta = pDM_Odm->pODM_StaInfo[i]))!=0)
                        {
	...
	)
{
	...
	ODM_SetRFReg(pDM_Odm, RF_PATH_A, RF_CHNLBW, bRFRegOffsetMask,(u32)CurrentChannel);
	ODM_SetRFReg(pDM_Odm,	RF_PATH_A,0x00, bRFRegOffsetMask,(u32)RfLoopReg);
