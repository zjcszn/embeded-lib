...
bInteralPA=bInteralPA;
	...
	ThermalValue = (u1Byte)ODM_GetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_A, RF_T_METER_88E, 0xfc00);	//0x42: RF Reg[15:10] 88E
...
//		if(!pHalData->ThermalValue)
		...
		if(delta > 0 && pDM_Odm->RFCalibrateInfo.TxPowerTrackControl)
		{
			...
			if(pDM_Odm->RFCalibrateInfo.TxPowerTrackControl /*&& !pHalData->bNOPG*/)			
			{
				...
				ODM_RT_TRACE(pDM_Odm,ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("TxPwrTracking 0xc80 = 0x%x, 0xc94 = 0x%x RF 0x24 = 0x%x\n", ODM_GetBBReg(pDM_Odm, 0xc80, bMaskDWord), ODM_GetBBReg(pDM_Odm, 0xc94, bMaskDWord), ODM_GetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_A, 0x24, bRFRegOffsetMask)));
			}			
		}
	...
	)
{
	...
	ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_A, RF_WE_LUT, bRFRegOffsetMask, 0x800a0 );
	ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_A, RF_RCK_OS, bRFRegOffsetMask, 0x30000 );
	ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_A, RF_TXPA_G1, bRFRegOffsetMask, 0x0000f );
	ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_A, RF_TXPA_G2, bRFRegOffsetMask, 0xf117B );
	
	//PA,PAD off
	ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_A, 0xdf, bRFRegOffsetMask, 0x980 );
	ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_A, 0x56, bRFRegOffsetMask, 0x51000 );
	...
	{	
		//reload RF 0xdf
		ODM_SetBBReg(pDM_Odm, rFPGA0_IQK, bMaskDWord, 0x00000000);
		ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_A, 0xdf, bRFRegOffsetMask, 0x180 );//if Tx not OK, ignore Rx
		return result;
	}
	...
	ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_A, RF_RCK_OS, bRFRegOffsetMask, 0x30000 );
	ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_A, RF_TXPA_G1, bRFRegOffsetMask, 0x0000f );
	ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_A, RF_TXPA_G2, bRFRegOffsetMask, 0xf7ffa );
	ODM_SetBBReg(pDM_Odm, rFPGA0_IQK, bMaskDWord, 0x80800000);
	...
	//reload RF 0xdf
	ODM_SetBBReg(pDM_Odm, rFPGA0_IQK, bMaskDWord, 0x00000000);
	ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_A, 0xdf, bRFRegOffsetMask, 0x180 );
	...
	)
{
...
#else
		RF_Amode = ODM_GetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_A, RF_AC, bMask12Bits);

		//Path-B
		if(is2T)
			RF_Bmode = ODM_GetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_B, RF_AC, bMask12Bits);	
#endif	

		//2. Set RF mode = standby mode
		//Path-A
		ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_A, RF_AC, bMask12Bits, (RF_Amode&0x8FFFF)|0x10000);

		//Path-B
		if(is2T)
			ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_B, RF_AC, bMask12Bits, (RF_Bmode&0x8FFFF)|0x10000);			
	}
...
#else
	LC_Cal = ODM_GetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_A, RF_CHNLBW, bMask12Bits);
#endif	
	
	//4. Set LC calibration begin	bit15
	ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_A, RF_CHNLBW, bMask12Bits, LC_Cal|0x08000);
	...
	{  
		...
		ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_A, RF_AC, bMask12Bits, RF_Amode);
		
		//Path-B
		if(is2T)
			ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_B, RF_AC, bMask12Bits, RF_Bmode);
	}
	else // Deal with Packet TX case
	{
...
//#endif
	...
	for(path = 0; path < pathbound; path++)
	{
		...
		{
			ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_B, RF_AC, bMaskDWord, 0x10000);			
		}
		else			//Path A to standby mode
		{
			ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_A, RF_AC, bMaskDWord, 0x10000);			
			ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_A, RF_MODE1, bMaskDWord, 0x1000f);			
			ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_A, RF_MODE2, bMaskDWord, 0x20103);						
		}
...
#else
			ODM_RT_TRACE(pDM_Odm,ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("phy_APCalibrate_8188E() offset 0xc %x\n", ODM_GetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) path, RF_IPA_A, bMaskDWord)));		
			ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) path, RF_AC, bMaskDWord, APK_RF_value_0[path][index]);
			ODM_RT_TRACE(pDM_Odm,ODM_COMP_CALIBRATION, ODM_DBG_LOUD,  ("phy_APCalibrate_8188E() offset 0x0 %x\n", ODM_GetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) path, RF_AC, bMaskDWord)));		
			ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) path, RF_TXBIAS_A, bMaskDWord, tmpReg);
			ODM_RT_TRACE(pDM_Odm,ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("phy_APCalibrate_8188E() offset 0xd %x\n", ODM_GetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) path, RF_TXBIAS_A, bMaskDWord)));					
#endif
	...
	for(path = 0; path < pathbound; path++)
	{
		...
		{
			ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_A, RF_MODE1, bMaskDWord, 0x1000f);			
			ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_A, RF_MODE2, bMaskDWord, 0x20101);						
		}
	...
	)
{
	...
	u4Byte			IQK_BB_REG_92C[IQK_BB_REG_NUM] = {
					...
					rOFDM0_RxIQExtAnta};
	BOOLEAN		is2T;
channelToIQK=channelToIQK;
RegE9C=RegE9C;
RegEAC=RegEAC;
RegEBC=RegEBC;
RegECC=RegECC;
RegTmp=RegTmp;
bStartContTx=bStartContTx;
	...
	)
{
	...
	ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_A, 0x0c, bMaskDWord, 0x8992b);
	ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_A, 0x0d, bMaskDWord, 0x0e52c); 	
	ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_A, 0x00, bMaskDWord, 0x5205a );		
	...
	if(is2T)
	{
		...
		//Path-B RF lpbk
		ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_B, 0x0c, bMaskDWord, 0x8992b);
		ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_B, 0x0d, bMaskDWord, 0x0e52c);
		ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_B, RF_AC, bMaskDWord, 0x5205a); 
	...
	for(path = 0; path<DP_PATH_NUM; path++)
	{
		for( i = 0 ; i < DP_RF_REG_NUM ; i++){
			ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) path, RF_REG[i], bMaskDWord, RF_backup[path][i]);
		}
	}
	ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_A, RF_MODE1, bMaskDWord, 0x1000f);	//standby mode
	ODM_SetRFReg(pDM_Odm,(ODM_RF_RADIO_PATH_E) RF_PATH_A, RF_MODE2, bMaskDWord, 0x20101);		//RF lpbk switches off
