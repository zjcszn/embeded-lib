...
void bsp_qspi_init(void) {
    ...
    dev_qspi.hqspi.Init.ChipSelectHighTime = QSPI_CS_HIGH_TIME_2_CYCLE;  /* 命令之间的 CS 片选至少保持 2 个时钟周期的高电平 */
    dev_qspi.hqspi.Init.ClockMode = QSPI_CLOCK_MODE_0;  /* MODE0: 空闲期间时钟保持低电平; MODE3: 空闲期间时钟保持高电平 */
